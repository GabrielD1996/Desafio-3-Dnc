    ...
    return (
        <section className={styles.Projects} id="projects">
            ...
            <div className={styles.cardSection}>
                <Cards img={firstPage} site='https://primeiro-projeto-luck.netlify.app' title='Landing Page DNC' tech='HTML,CSS,JS'
                ...
                <Cards img={challengeOne} site='https://primeiro-projeto-luck.netlify.app' title='Primeiro desafio DNC' tech='HTML,CSS'
